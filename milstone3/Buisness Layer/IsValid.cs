...
namespace milstone3
{
    class IsValid
    {
        ...
        public static bool isValidDate(DateTime duedate)
        {
            if (duedate.Date.CompareTo(DateTime.Today.Date) < 0)
            {
                log.Error("Date not valid: " + duedate.ToString());
                return false;
            }
            else
                return true;
        ...
        public static Boolean isValidTask(String title, String description,DateTime dueDate)
        {
